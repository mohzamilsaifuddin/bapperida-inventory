        ...
        <form action={addBarang} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" name="kode_barang" className={inputClass} placeholder="Misal: BRG-001" required />
            </div>

            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Nama Barang</label>
              <input type="text" name="nama_barang" className={inputClass} placeholder="Nama inventaris" required />
            </div>

            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Kategori</label>
              <select name="kategori_id" className={inputClass} required>
            ...
            <div>
              ...
              <input type="text" name="satuan" className={inputClass} placeholder="Misal: Pcs, Unit, Rim" required />
            </div>

            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Stok Minimum</label>
              <input type="number" name="stok_minimum" min="0" className={inputClass} placeholder="0" required />
            ...
            <div>
              ...
              <input type="text" name="lokasi" className={inputClass} placeholder="Misal: Gudang A" />
            </div>
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2">Keterangan (Opsional)</label>
            <textarea name="keterangan" rows={3} className={inputClass} placeholder="Keterangan tambahan..."></textarea>
          </div>
